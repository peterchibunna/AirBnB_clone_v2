...
Routes:
    ...
    /number_template/<n>: Displays its own bla bla bla'
"""
...
def hello_hbnb7(n):
    ...
    try:
        number = int(n)
        is_even_or_odd = "even" if number % 2 == 0 else "odd"
        return render_template(
            "6-number_odd_or_even.html", number=int(n),
            is_even_or_odd=is_even_or_odd)
    except ValueError:
        pass
