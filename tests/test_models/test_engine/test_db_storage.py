...
class TestDBStorage(unittest.TestCase):
    ...
    def test_new_and_save(self):
        ...
        new_user = User(**{'first_name': 'Max',
                           'last_name': 'Pollens',
                           'email': 'max@powerhouse.com',
                           'password': '895hus$7dfhP'})
        cur = db.cursor()
    ...
    def test_new(self):
        ...
        new = User(
            email='john_doe.smith@gmail.com',
            password='password',
            first_name='Max',
            last_name='SmithDoe'
        )
    ...
    def test_reload(self):
        ...
        dbc.commit()
        storage.reload()
        self.assertIn('User.User.8ded-7d232d5e5a14', storage.all())
        cursor.close()
        dbc.close()
